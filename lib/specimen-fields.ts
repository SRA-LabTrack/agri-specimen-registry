...
export const specimenFields: SpecimenField[] = [
  ...
  { key: "area", label: "Area", group: "Collection location", type: "text", placeholder: "Optional" },
  { key: "site", label: "Site", group: "Collection location", type: "text", placeholder: "Optional" },
  ...
  { key: "colonyMargin", label: "Colony margin", group: "Culture & microscopy", type: "text", placeholder: "Optional" },
  { key: "colonyElevation", label: "Colony elevation", group: "Culture & microscopy", type: "text", placeholder: "Optional" },
  { key: "colonyShape", label: "Colony shape", group: "Culture & microscopy", type: "text", placeholder: "Optional" },
  { key: "colonyColour", label: "Colony colour", group: "Culture & microscopy", type: "text", placeholder: "Optional" },
  { key: "colonyDiameter", label: "Colony diameter", group: "Culture & microscopy", type: "text", placeholder: "Optional; include the recorded unit" },
  { key: "cellShape", label: "Cell shape", group: "Culture & microscopy", type: "text", placeholder: "Optional" },
  { key: "gramStainingReaction", label: "Gram staining reaction", group: "Culture & microscopy", type: "text", placeholder: "Optional; for example + or -" },
